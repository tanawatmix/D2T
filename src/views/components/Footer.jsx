...
const Footer = () => {
  ...
  return (
    <footer className="dark:bg-secondary font-sriracha bg-primary mt-auto border-t transition duration-500 border-blue-400 dark:border-pink-400">
      <div className="max-w-5xl mx-auto px-4 py-6 flex flex-col gap-6 md:flex-row md:justify-between md:items-center">
        {/* Left: Brand & Info */}
        <div className="flex flex-col gap-1 items-center md:items-start text-center md:text-left flex-1">
          <h2
            className={`text-2xl w-full font-extrabold tracking-tight bg-clip-text text-transparent select-none bg-[length:200%_auto] animate-gradient-anim ${gradientText}`}
          >
            Dare2Thai
          </h2>
          <p
            className={`text-sm font-light tracking-tight bg-clip-text text-transparent select-none bg-[length:200%_auto] animate-gradient-anim ${gradientText}`}
          >
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-center flex-1">
          <div className="flex items-center gap-2">
            <a
              ...
              className={`transition-colors hover:text-pink-400 dark:hover:text-sky-400 ${darkMode ? "text-blue-400" : "text-blue-400"}`}
